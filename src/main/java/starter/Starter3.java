...
public class Starter3 extends RecursiveTask<List<List<Edge>>> {
	...
	public Starter3(File file) {
	}
	public  Starter3(SkeletonPatt input, int maxNumberOfSimulation, int simulatedAnnealingMaxIter, String outputDir, int maxNumberOfResources) {
