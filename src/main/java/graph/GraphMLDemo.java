...
//                edgeLabelProvider, edgeAttributeProvider);
        GraphExporter<CustomVertex,
        DefaultWeightedEdge> exporter = new JSONExporter<CustomVertex,DefaultWeightedEdge>(
            vertexIdProvider,  vertexAttributeProvider, edgeIdProvider,
